                    ...
                    <div class="card shadow mb-3">
                        ...
                        <div class="card-body">
                            <form>
                                ...
                                <div class="mb-3"><button class="btn bg-purple btn-sm" type="submit" style="color:#fff;margin-top: 20px;">Save Changes</button></div>
                            </form>
                        </div>
                    </div>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="txt-purple m-0 fw-bold">Personal Information</p>
                        </div>
                        <div class="card-body">
                            <form>
