...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-header py-3" style="height: 64px;">
            <button class="btn btn-info btn-sm float-end mb-3 add-row"
                onclick="document.location='{{ url('register-tournament') }}'" type="button"
                style="margin: 0px;width: 170px;background: rgb(78,115,223);border-color: rgb(78,115,223);color: var(--bs-gray-300);">
                <i class="fas fa-plus"></i><strong>&nbsp;Add Tournament</strong>
            </button>
            <p class="text-primary m-0 fw-bold" style="width: 978px;">List of Tournaments </p>
        ...
        <div class="card-body">
            <a href="/bracket?data=tournament&type=generator" target="_blank" class="btn btn-sm btn-primary"><i
                    class="fas fa-code-branch" style="width: 20px;"></i>&nbsp;Generate Bracket</a>
            <div class="row">
                <div class="col-md-6 text-nowrap">
            ...
            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                <table class="table my-0" id="dataTable">
                    <thead>
                        <tr>
                            <th style="background: transparent;color: rgb(133,135,150);height: 50px;">Tournament Name
                            </th>
                            <th style="background: transparent;color: rgb(133,135,150);">Type</th>
                            <th style="background: transparent;color: rgb(133,135,150);">Game</th>
                            <th style="background: transparent;color: rgb(133,135,150);">Size</th>
                            <th style="background: transparent;color: rgb(133,135,150);height: 25px;">Format</th>
                            <th style="background: transparent;color: rgb(133,135,150);">Schedule</th>
                            <th style="background: transparent;color: rgb(133,135,150);">On-Going</th>
                            <th class="text-center" style="background: transparent;color: rgb(133,135,150);">Delete</th>
                        </tr>
                    </thead>
                    @if (count($tournaments) > 0)
