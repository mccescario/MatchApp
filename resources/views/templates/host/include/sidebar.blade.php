<nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: #1b1b1b;">
    <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
        ...
        <ul class="navbar-nav text-light" id="accordionSidebar">
            ...
            <li class="nav-item"><a class="nav-link" href="{{ route('host-profile', Auth::user()->id) }}"><i class="fas fa-user-alt" style="width: 20px;"></i><span>Profile</span></a></li>
            ...
            <li class="nav-item"><a class="nav-link" href="{{ route('tournament_manage') }}"><i class="fas fa-trophy" style="width: 20px;"></i><span>Tournaments</span></a></li>
