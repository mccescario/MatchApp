...
@section('content')
    ...
    <div>
        <a href="{{ url()->previous() }}" class="btn mb-3 bg-purple" style="color:#fff;"> Back</a>
    </div>
            ...
            <div class="col-lg-4">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="txt-purple fw-bold m-0">Set Schedule</h6>
                    </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="card shadow mb-3">
                            <div class="card-header py-3">
                                <p class="txt-purple m-0 fw-bold">Customize Tournament</p>
                            </div>
                            <div class="card-body">
                                <form action="{{ url('tournament.store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <button class="btn btn-sm bg-purple" type="submit" style="width: 150.5px;height: 38px;color:#fff;">Create Tournament</button></div>
