...
<div class="container-fluid">
    ...
    <div class="mb-3 row">
        <div class="col-lg-4">
            <a href="{{ route('tournament.bracket', $tournament->id) }}" class=" btn bg-purple" style="color:#fff;">Generate Bracket</a>
        </div>
                        ...
                        <div class="card-body" style="width: 850.6600000000002px;">
                            <form method="POST" action="{{ route('tournament.update' , $tournament->id) }}">
                                ...
                                <div class="mb-3" style="margin-left: 0px;height: 25px;">
                                    <button class="btn btn-sm bg-purple" style="color:#fff;" type="submit">
    ...
    <div class="col-12">
        <div class="shadow card">
            <div class="py-3 card-header" style="height: 48px;">
                <p class="txt-purple fw-bold" style="margin-top: -4px;">List of Participants</p>
            </div>
            <div class="card-body">
                <form>
                    <div class="row">
...
<div class="mb-3 row">
    <h3 class="mb-4 txt-purple">Joining Teams</h3>
    <div class="col">
        <div class="shadow card">
            <div class="py-3 card-header" style="height: 48px;">
                <p class="txt-purple fw-bold" style="margin-top: -4px;">List of Teams</p>
            </div>
            <div class="card-body">
                <form>
                    <div class="row">
                    ...
                    <tbody class="">
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route('matches.show', $match->id) }}}"
                                    class="btn bg-purple text-white">View</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
