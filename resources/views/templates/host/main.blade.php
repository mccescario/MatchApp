...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('../images/matchapp-icon.png') }}"  type='image/x-icon'>
    
    <style>
      @font-face { 
          font-family: AvenirRegular; src: url('../fonts/AvenirNextLTPro-Regular.otf');
      ...
      .green-color-bg{
          background-color:#02130d !important;
          color:#fff !important;
      ...
      .gold-color-bg{
          ...
          border:solid 1px #02130d !important;

      }
      .bg-purple{
          background: #2A1C45  !important;
      }
      .txt-purple{
          color: #2A1C45 !important;
      }
    </style>
...
<body id="page-top" style="font-family: AvenirRegular !important; ">
    <div id="wrapper">
        @include('templates.host.include.sidebar')

        <div class="d-flex flex-column" id="content-wrapper" style="background-color:#f9f7f2;">
            <div id="content" class=" text-color-green" >
