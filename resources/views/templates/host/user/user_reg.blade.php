...
@section('content')
    ...
    <form action="{{ url('tournament') }}" method="POST" x-data="{bracket: 1, sports: 1, fee: 2}" >
        @csrf
        ...
        <div class="d-xl-flex justify-content-xl-center align-items-xl-center" style="margin: -8px;">
            ...
            <div style="margin: 13px;" x-show="sports == 2">
                ...
                <select style="padding: 1px 2px;" name="tournament_esport">
        ...
        <div class="d-xl-flex justify-content-xl-center align-items-xl-center" style="margin: -8px;">
            <div x-show="bracket == 1" >
                ...
                <div class="my-1">
                    ...
                    <input type="number" name="single_bracket_size" id="">
                </div>

                <div class="my-1">
                    <x-jet-label class="form-label" value="{{ __('Best of for all rounds: ')}}"/>
                    <select name="single_best_of_rounds" style="padding: 1px 2px;">
            ...
            <div x-show="bracket == 2" style="margin: 13px;">
                <div>
                    <x-jet-label class="form-label" value="{{ __('Bracket Size (# of teams/ players): ')}}"/>
                    <input type="number" name="double_bracket_size" id="">
                </div>
