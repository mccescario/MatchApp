        ...
        <div class="col">
            <div class="card shadow">
                <div class="card-header py-3" style="height: 64px;">
                    <p class="green-color-text m-0 fw-bold" style="width: 978px;">Team Members</p>
                </div>
                <div class="card-body" style="margin-top: -15px;"><br>
                    ...
                    <div class="table-responsive table mt-2" id="dataTable-2" role="grid" aria-describedby="dataTable_info">
                        <table class="table my-0" id="dataTable">
                            <thead>
                                <tr>
                                    <th class="green-color-text" style="width: 500px;">Team Name</th>
                                    <th class="green-color-text" style="width: 170px;">Message</th>
                                    <th class="green-color-text" style="width: 170px;">Status</th>
                                </tr>
                            </thead>
                            <tbody>
