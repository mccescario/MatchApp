    ...
    <div class="col-12 row">
        <div class="col-6">
            <ul class="nav justify-content-start">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('player-dashboard') }}">Matches</a>
                </li>
                <li class="nav-item">
                    <a class="underline nav-link active" href="#"><u>Tournaments</u></a>
                </li>
            </ul>
        </div>
            ...
            <div class="mb-4 col-12">
                <div class="mx-auto card" style="width: 560px;">
                    <div class="card-body">
                        ...
                        <a href="{{ route('newsfeed.tournament.show', $tournament->id) }}" class="btn btn-primary">View
