...
<head>
    ...
    <title>@yield('title','MatchApp - Standard') </title>
...
<body id="page-top"  style="font-family: AvenirRegular;">
    <div id="wrapper">
        @include('templates.normal.include.sidebar')

        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content" class=" text-color-green" style="background-color:#f9f7f2;">
