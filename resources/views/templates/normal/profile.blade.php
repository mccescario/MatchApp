...
<div class="container-fluid">
    <h3 class="txt-purple mb-4">Profile</h3>
        ...
        <div class="col-lg-4">
            <div class="card mb-3">
                <form action="{{ route('profilemanagement.update',Auth::user()->id) }}" method="PATCH" enctype="multipart/form-data">
                    ...
                    <div class="card-body text-center shadow">
                        ...
                        <div class="mb-3">
                            <button class="btn btn-sm bg-purple" style="color: #fff;" type="submit">Change Photo</button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="txt-purple fw-bold m-0">Password Change</h6>
                </div>
                <div class="card-body">
                    ...
                    <div class="small">
                        ...
                        <div class="row">
                            ...
                            <button class="btn btn-sm bg-purple" style="color: #fff;" type="submit">Change Password</button>
                        </form>
                    </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="card shadow mb-3">
                        <div class="card-header py-3">
                            <p class="txt-purple m-0 fw-bold">Account Credentials</p>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('profilemanagement.update',Auth::user()->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    <button class="btn btn-sm bg-purple" style="color: #fff;" type="submit">Save&nbsp;Changes</button></div>
                            </form>
                        </div>
                    </div>
                </div>
