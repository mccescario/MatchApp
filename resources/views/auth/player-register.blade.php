...
@section('content')
<form action="{{ route('user.registration.player.store') }}" method="POST">
    @csrf
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        {!! \Orchid\Screen\Fields\Select::make('course_id')
        ->fromModel(\App\Models\Course::class, 'name')
        ->required()
        ->tabIndex(9)
        !!}
    </div>
    ...
    <div class="mb-3">
        ...
        {!! \Orchid\Screen\Fields\Select::make('sport_id')
        ->fromModel(\App\Models\Sport::class, 'name')
        ->required()
        ->tabIndex(10)
        !!}
    </div>
    ...
    <div class="mb-3">
        ...
        {!! \Orchid\Screen\Fields\Input::make('student_number')
        ->type('text')
        ->required()
        ->tabindex(11)
        !!}
